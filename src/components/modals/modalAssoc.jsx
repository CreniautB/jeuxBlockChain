...
const ModalAssoc = ({ closeModal, closeCross }) => {
  ...
  return (
    <div className="modal">
      ...
      <p className="paragrapheScroll">
        ...
        resultant pleasure?" "Sed ut perspiciatis unde omnis iste natus error
        ...
        dolorem eum fugiat quo voluptas nulla pariatur?""But I must explain to
        you how all this mistaken idea of denouncing pleasure and praising pain
